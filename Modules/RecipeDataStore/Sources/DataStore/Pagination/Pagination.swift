...
public struct Pagination: Identifiable, Hashable {
    ...
    public init(id: UUID = UUID(), entityType: EntityType, totalCount: Int = 10, currentPage: Int = 10, lastUpdated: Date = Date()) {
        self.id = id
...
extension Pagination {
    public init(from paginationDomain: PaginationDomain) {
